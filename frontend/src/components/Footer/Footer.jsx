      ...
      <div className="footer-container">
        ...
        <div className="footer-row">
          <div className="footer-col footer-col-address">
            ...
            >
              <img src="/multiicon.svg" alt="MultiIcon" />
            </div>
            <p className="footer-address-line">Office No 301/302/303,<br/> Rumi Plaza,<br/> Third Floor,<br/> Maruti Nagar 3 Corner,<br/> Airport Road, Rajkot, Gujarat 360005, India</p>
          </div>
